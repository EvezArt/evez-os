...
MILESTONE       = "COOL_DOWN_POST_PRIME_BLOCKS"

# ── DERIVED ARCHITECTURE ───────────────────────────────────────────
TOPOLOGY_BONUS  = 1 + math.log(N) / 10        # 1.412713
LOG2_N1         = math.log2(N + 1)             # 5.977280
...
# ── ASSERTIONS ─────────────────────────────────────────────────────
assert POLY_C < 0.500, "COOL: N=62=2x31 tau=2, poly_c must be < 0.500"
assert not FIRE_IGNITED, "No fire at cool N"
...
OMEGA = (
    ...
    "Post two consecutive prime blocks (R107 N=59, R109 N=61). "
    "drift_vel=0.107005 ACCELERATING x28. floor_prox ADVANCING x41. "
...
R111_GAP = (
    ...
    "poly_c ~ 0.512 -- FIRE CANDIDATE. "
    "topology_bonus*(1+ln(3))/log2(64) ~ 0.512. Watch carefully."
)
